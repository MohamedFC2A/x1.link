    ...
    >
      <div className="flex items-center gap-2 mb-1.5 px-1 text-xs text-zinc-300">
        <div className="flex items-center gap-1.5 font-sans font-medium">
          {isMedia ? (
            <div className="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-violet-950/80 border border-violet-500/30 text-violet-200 shadow-sm">
              <Sparkles className="w-3.5 h-3.5 text-violet-300" />
              <span className="font-semibold text-xs text-violet-100">محرك Fathom Spark</span>
            </div>
          ) : isCyber ? (
