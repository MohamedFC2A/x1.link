                ...
                a: ({ href, children }: any) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "inline-flex items-center gap-1.5 px-2.5 py-0.5 my-0.5 rounded-lg border font-mono text-xs sm:text-sm font-medium transition-all cursor-pointer shadow-sm mx-1 align-baseline select-none active:scale-95 backdrop-blur-md",
                        isTel
                          ? "bg-emerald-950/40 hover:bg-emerald-900/60 border-emerald-500/30 hover:border-emerald-400/60 text-emerald-300 hover:text-white"
                          : "bg-white/[0.06] hover:bg-white/[0.12] border-white/[0.14] hover:border-white/40 text-zinc-100 hover:text-white"
                      )}
                    ...
                    >
                      {isTel ? (
                        ...
                        <Globe className="size-3 text-zinc-300 group-hover:text-white shrink-0 inline-block" />
                      )}
                      <span className="break-all underline underline-offset-2">{children}</span>
                      {!isTel && (
                        <ExternalLink className="size-2.5 opacity-70 shrink-0 inline-block" />
                      )}
                    </button>
                  );
                },
