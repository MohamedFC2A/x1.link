    ...
    const intentLabelMap: Record<UserIntentCategory, { ar: string; mode: string; directive: string }> = {
      ...
      SVG_VECTOR_STUDIO_AND_DESIGN: {
        ...
        directive: 'أنت مهندس ومصمم فيكتور ومصور بصري فائق الاحترافية والدقة (Principal Vector Architect): ' +
          ...
          '8) بروتوكول تحويل الصور المرفوعة إلى فيكتور وتعديلها (Image-to-SVG Vision Reconstruction & Transformation): عند إرفاق صورة للمحادثة والمطالبة بتحويلها إلى فيكتور أو التعديل عليها أو إدخال/حذف عناصر منها، تفحّص محتوى الصورة واستوعب بنيتها البصرية وأشكالها وألوانها بدقة، ثم أعد بناء وتجسيد الصورة ككود SVG متقن قابل للتعديل والتحجيم والتصدير، وطبّق فوراً كافة التعديلات والتوجيهات المطلوبة من المستخدم (مثل إضافة كائن، تغيير لوحة الألوان، تبديل الخلفية، تحوير الأشكال) دون نقصان. ' +
