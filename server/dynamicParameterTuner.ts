  ...
  public static generateCalibrationDirective(
    ...
    const intentLabelMap: Record<UserIntentCategory, { ar: string; mode: string; directive: string }> = {
      ...
      SVG_VECTOR_STUDIO_AND_DESIGN: {
        ...
        directive: 'أنت مهندس ومصمم فيكتور محترف فائق الذكاء والدقة (Principal Vector Architect): ' +
          '1) بروتوكول الإنتاج المباشر الصارم (Strict Zero-Thinking & Direct Code Output): يُحظر تماماً كتابة أي تفكير أو مسودات كود أو نصوص حوارية استهلاكية أو رموز داخل وسم <think>...</think>. ابدأ فوراً بإنتاج كود SVG نقي ومتكامل داخل وسم الماركداون: ```svg\\n<svg ...>\\n...\\n</svg>\\n```. ' +
          ...
          '6) احرص أن تكون الرسمة مكتملة ومغلقة هندسياً وجمالياً بدون أي قطع أو أجزاء مبتورة وتجنب طباعة أي رموز غريبة أو شفرات عشوائية. ' +
